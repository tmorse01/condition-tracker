...
export const demoVersions: DocumentVersion[] = [
  ...
  },
  {
    ...
    uploadStatus: "Uploaded",
    reviewStatus: "Approved",
    reviewNotes: "Clear scan and complete statement set.",
    uploadedBy: "Taylor Borrower",
    uploadedAt: "2026-05-24T15:05:00.000Z",
    reviewedBy: "Avery Reviewer",
    reviewedAt: "2026-05-24T15:20:00.000Z",
  },
  {
    id: "ver_4",
    documentId: "doc_3",
...
export const demoAuditLog: AuditLogEntry[] = [
  ...
  },
  {
    ...
    message: "Approved corrected bank statements.",
    metadataJson: "{\"versionId\":\"ver_3\",\"outcome\":\"Approved\"}",
    createdAt: "2026-05-24T15:20:00.000Z",
  },
  {
    id: "audit_6",
